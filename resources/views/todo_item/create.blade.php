<x-app-layout>
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<div class="mx-4 sm:p-8">
			<form method="post" action="{{route('todo_item.store')}}" enctype="multipart/form-data">
				@csrf
				<div class="md:flex items-center mt-8">
					<div class="w-full flex">
					<label for="item_name" class="font-semibold leading-none mt-4">項目名</label>
					<input type="text" name="item_name" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="title" placeholder="Enter Title">
					</div>
				</div>
